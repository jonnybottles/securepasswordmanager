...
public class UserDataService {
    ...
    public boolean createUserDataDirectory() {
        ...
        // Obtain the path to the users current working directory / where the program was exeuted from.
        ...
        File userDirectory = new File(currentPath + File.separator + "user_data");

        if (!userDirectory.exists()) {
            try {
                boolean wasCreated = userDirectory.mkdirs();
                if (!wasCreated) {
                    return false;
                }
